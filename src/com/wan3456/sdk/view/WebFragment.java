...
public class WebFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View v = inflater.inflate(
				Helper.getLayoutId(getActivity(), "wan3456_fragment_web"),
				null, false);
		sharedPreferences = getActivity().getSharedPreferences(
				"yssdk_info",
				Context.MODE_PRIVATE);

		if (mTitle.equals("礼包中心")) {
			String sign = "area_id="+sharedPreferences.getInt("serId", 0)+"&gameid=" + sharedPreferences.getInt("gameID", -1)
		...
		TextView tv = (TextView) v.findViewById(Helper.getResId(getActivity(),
				"wan3456_web_title"));
		tv.setText(mTitle);
		back = (Button) v.findViewById(Helper.getResId(getActivity(),
				"wan3456_fra_web_back"));
	   ...
	   webview.loadUrl(mURL);	
		bar = (ProgressBar) v.findViewById(Helper.getResId(getActivity(),
				"wan3456_web_bar"));
		View btn = v.findViewById(Helper.getResId(getActivity(),
				"wan3456_web_back"));
	...
	class MyChromeClient extends WebChromeClient {
		...
		public boolean onJsAlert(WebView view, String url, String message,
			...
			InterTool.getInstance(getActivity()).copy(getActivity(),message);
			result.confirm();
			return true;
		}
